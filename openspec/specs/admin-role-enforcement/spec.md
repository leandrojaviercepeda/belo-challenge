...
El endpoint GET /admin/users debe permitir listar todos los usuarios del sistema.

#### Scenario: Admin accesses user list

- **WHEN** un admin hace request a GET /admin/users
- **THEN** la respuesta retorna un array con todos los usuarios

#### Scenario: Non-admin denied from user list

- **WHEN** un usuario regular hace request a GET /admin/users
- **THEN** la respuesta es 403 Forbidden
